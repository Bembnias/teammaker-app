  ...
  return (
    <aside className='hidden lg:flex flex-col sticky top-16 lg:min-w-80 px-6 h-[calc(100vh-4rem)]' style={{backgroundColor: "#171717"}}>
      ...
      <div className='flex gap-x-6 mx-auto mt-8'>
        <Link to={'/league-of-legends'} className={`sidebar-game-tile ${pathname.includes("league-of-legends") && 'active-tile'}`} style={{backgroundColor: "#1663BE"}}>
          <img className=' w-full' src={LolLogo} alt="lol logo png" />
        </Link>
        <Link to={'/cs-go'} className={`sidebar-game-tile ${pathname.includes("cs-go") && 'active-tile'}`} style={{backgroundColor: "#DE9B35"}}>
          <img className=' w-full' src={CSGOLogo} alt="lol logo png" />
        </Link>
        <Link to={'/brawl-stars'} className={`sidebar-game-tile ${pathname.includes("brawl-stars") && 'active-tile'}`} style={{backgroundColor: "#333333"}}>
      ...
      <div className='flex flex-col mt-14 gap-y-1 text-white'>
        <Link to={'/choose-a-game'} className='p-1 uppercase text-left font-semibold rounded-md py-2 justify-center hover:bg-black hover:text-pinkish ease-in-out duration-300'>  
          <i className='bx bxs-home ml-2 mr-1' ></i> search for a team
        </Link>
        <Link to={`/respect-ranking`} className='p-1 uppercase text-left font-semibold rounded-md py-2 justify-center hover:bg-black hover:text-pinkish ease-in-out duration-300'>  
